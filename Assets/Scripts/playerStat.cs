...
//>>>>>>> origin/master
    ...
    void CmdSoulDrop()
    {
		...
		NetworkServer.Spawn (BloodSpill1);
		...
		NetworkServer.Spawn (BloodSpill2);
		...
		NetworkServer.Spawn (BloodSpill3);
		...
		NetworkServer.Spawn (BloodSpill4);
		...
		NetworkServer.Spawn (BloodSpill5);
